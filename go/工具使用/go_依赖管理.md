...
本次 @盛傲飞 的夜读分享，是对 Go Modules 的一次很好的解读，比较贴近工程实践。
...
![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/df9946d8a06847d3b809309b619c21e7~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/12a0313dbcf04fb0a00d82c560a146f2~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/cb3403e0adf54669bf36596d3beab277~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)

如果有兴趣的小伙伴可以看看 [Proposal: Secure the Public Go Module Ecosystem](https://link.juejin.cn?target=https%3A%2F%2Fgo.googlesource.com%2Fproposal%2F%2B%2Fmaster%2Fdesign%2F25530-sumdb.md%23proxying-a-checksum-database "https://go.googlesource.com/proposal/+/master/design/25530-sumdb.md#proxying-a-checksum-database")，有详细介绍其算法机制，如果想简单一点，查看 `go help module-auth` 也是一个不错的选择。
...
![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d86222ebdaa643b4ba364cf3506ea668~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)

### 坑 2: 管理 Go 的环境变量

![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dd042bd5ed5f42f49888cdb1ec5d4e14~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)

这里主要是提到 Go1.13 新增了 `go env -w` 用于写入环境变量，而写入的地方是 `os.UserConfigDir` 所返回的路径，需要注意的是 `go env -w` 不会覆写。

### 坑 3: 从 dep、glide 等迁移至 Go Modules

![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e5a22f4d8f264af8a02964639527025e~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f6ab0da34d8d41f6b74e71044ba6f6ac~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2abdfb499df545578d9ea89b391850de~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)

### 坑 6:主版本号

![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6c557da8567e461db310ebbbf19fec95~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)

## Go Module Proxy 简介

![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/475cfe8984aa4f3baa20c0fb54dc9600~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7b6c578fa3e64f449b1deffb4fcd9ecd~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1651e7df02fe46c39a537a2d0a6b772f~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)

此处呈现的是存储大小，主要是针对模块包代码，而一般来讲代码并不会有多大，0-10MB，10-50MB 占最大头，也是能够理解，但是大于 100MB 的模块包代码就比较夸张了。

![image](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f87f984a0c554baca79a330fcdaf7d2a~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
**A：**GitLab 中配合 goget 而设置的 `<meta>` 存在些许问题，导致 Go 1.13 错误地识别了模块的具体路径，这是个 Bug，据说在 GitLab 的新版本中已经被修复了，详细内容可以看 [github.com/golang/go/i…](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fgolang%2Fgo%2Fissues%2F34094 "https://github.com/golang/go/issues/34094") 这个 Issue。然后目前的解决办法的话除了升级 GitLab 的版本外，还可以参考 [github.com/developer-l…](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fdeveloper-learning%2Fnight-reading-go%2Fissues%2F468%23issuecomment-535850154 "https://github.com/developer-learning/night-reading-go/issues/468#issuecomment-535850154") 这条回复。
...
作者：煎鱼eddycjy
链接：https://juejin.cn/post/6844903954879348750
来源：稀土掘金
